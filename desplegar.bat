...
REM
REM  Enlace bueno: https://pury.creskio.com
REM ============================================================
cd /d "E:\Escritorio\DEMOS ESTETICAS\Clinica Pury Ruiz"

echo.
echo  Publicando Pury Ruiz
echo  --------------------------------------------
echo.
